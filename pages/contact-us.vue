...
<template>
	<div class="-mt-32">
		<header class="relative bg-sky-800 pb-24 pt-32 sm:pb-32">
			...
			<div
				class="relative mx-auto mt-24 max-w-md px-4 sm:mt-32 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8"
			>
				<h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">Get in touch</h1>
				<p
					class="mt-6 max-w-3xl text-xl text-white"
				>We love to hear from our customers! If you have any further questions or queries please do not hesitate to get in touch. You can contact us by phone or email anytime.</p>
			</div>
		</header>
						...
						<div class="relative overflow-hidden bg-sky-700 py-10 px-6 sm:px-10 xl:p-12">
							...
							<dl class="mt-8 space-y-6">
								...
								<dd class="flex text-base text-indigo-50">
									...
									<a href="tel:+2348166593030" class="ml-3">+2348166593030</a>
								</dd>
								<dt>
				...
				<div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
					...
					>
						<div class="lg:w-0 lg:flex-1">
							...
							<p
								class="mt-4 max-w-3xl text-lg text-cyan-100"
							>Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui Lorem cupidatat commodo. Elit sunt amet fugiat.</p>
						</div>
						<div class="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:ml-8 lg:flex-1">
							<form class="sm:flex">
								...
								<button
									type="submit"
									class="mt-3 flex w-full items-center justify-center rounded-md border border-transparent bg-green-400 px-5 py-3 text-base font-medium text-white hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-cyan-700 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
								>Notify me</button>
							</form>
