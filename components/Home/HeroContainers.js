...
export default function HeroContainers() {
  return <section class="relative sm:-mt-24 z-10">
      <div class="mx-auto max-w-6xl">
        <dl class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
          ...
          <div class="flex flex-col border-t border-b border-gray-100 p-6 text-left sm:border-0 sm:border-l sm:border-r">
          ...
          <div class="flex flex-col border-t border-gray-100 p-6 text-left sm:border-0 sm:border-l">
            ...
            <dd class="order-1 text-xl tracking-tight themeText">
              <div class="flex items-center">
                <span class="uppercase mx-4 font-bold">
                  Online Consultation
                </span>
              </div>
            </dd>
